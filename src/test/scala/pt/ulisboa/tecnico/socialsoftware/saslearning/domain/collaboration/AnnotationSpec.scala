...
class AnnotationSpec extends WordSpec
  ...
  "An annotation" should {
    "have a content" when {
      ...
      "is not empty" in {
        val annotation = Annotation.fromUnsafe(None, 0l, 10l, "This is an annotation", user)
        val expected = Annotation(None, 0l, 10l, "This is an annotation", user)
    ...
    "have a offset >= 0" when {
      ...
      "equal to 0" in {
        ...
        val expected = Annotation(None, 0l, 0l, "This is an annotation", user)
        assertRight(expected = expected, actual = annotation)
      }
      "greater than 0" in {
        val annotation = Annotation.fromUnsafe(None, 0l, 1l, "This is an annotation", user)
        val expected = Annotation(None, 0l, 1l, "This is an annotation", user)
        assertRight(expected = expected, actual = annotation)
      }
    }
  }
